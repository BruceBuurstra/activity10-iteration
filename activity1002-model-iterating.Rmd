...
Why, or why not? Typically students like their professors more than they dont like them.
...
#score = 3.747 + 0.074*bty_avg + 0.172*gender(0-female, 1-male)
...
What are the two column names? rank and data
...
**Response**: All have very low values for bty_avg coefficient and not slighly as low for gendermale. The intercepts are all close to 4.
...
**Response**: All do a very bad job of explaining the variance in the model. Teaching does the best a little above 0.2.
...
**Response**: Seems to do very well, no apparent outliers and no general shapes or pattern.
